...
import { Briefcase, DoorClosed, DoorOpen, MapPinIcon, Theater } from 'lucide-react';
...
const Job = () => {
  ...
  const {fn:fnjobs , data:job , loading:lodingjobs}= useFetch(getSinglejob,{
    job_id: id,
  });

  const {fn:fnHiringStatus, loading:lodingHiringStatus}= useFetch(updateHiringStatus,{
    job_id: id,
  });
  ...
  {lodingHiringStatus && <BarLoader width={"100%"} color='#36d7b7'/>}
   ...
   {/* // view applicants and traking the applicants  */}
